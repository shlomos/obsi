...
int GroupRegexClassifier::configure(Vector<String> &conf, ErrorHandler *errh)
{
...
bool GroupRegexClassifier::is_valid_patterns(Vector<String> &patterns, ErrorHandler *errh) const{
    RegexSet test_set;
    bool valid = true;
