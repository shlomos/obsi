...
enum mwm_status {
	MWM_SUCCESS = 0,
	MWM_ERROR_DUPLICATE_PATTERN,
	MWM_ERROR_MAX_PATTERNS_EXCEEDED,
	MWM_ERROR_LONG_PATTERN,      // Long pattern
	MWM_ERROR_ZERO_PATTERN,      // Empty pattern (zero length)
	MWM_ERROR_AUTOMATA_CLOSED,   // Automata is closed
	MWM_ERROR_UNKNOWN,
};
...
#define BWSHIFTABLESIZE HASHTABLESIZE
